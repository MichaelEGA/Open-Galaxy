...
public static class MissionEditorFunctions
{
        ...
        if (missionName != "Untitled Mission")
        {
            foreach (Node node in missionEditor.nodes)
            {
                if (node != null)
                {
                    ...
                    missionEvent.data16 = ParseTextToString(node.data16);
                    missionEvent.data17 = ParseTextToString(node.data17);
                    missionEvent.data18 = ParseTextToString(node.data18);
                    missionEvent.data19 = ParseTextToString(node.data19);
                    missionEvent.data20 = ParseTextToString(node.data20);
    ...
    public static IEnumerator LoadMissionData(Mission mission)
    {
        ...
        foreach (MissionEvent missionEvent in mission.missionEventData)
        {
            ...
            InputData(node.data16, missionEvent.data16);
            InputData(node.data17, missionEvent.data17);
            InputData(node.data18, missionEvent.data18);
            InputData(node.data19, missionEvent.data19);
            InputData(node.data20, missionEvent.data20);
