...
public class NodeFunctions : MonoBehaviour
{
    ...
    public static void SelectNodeToDraw(Node node)
    {
        ...
        else if (node.nodeType == "exitanddisplaynextmissionmenu")
        {
            NodeTypes.Draw_ExitAndDisplayNextMissionMenu(node);
        }
        ...
        else if (node.nodeType == "ifshipislessthandistancetopointinspace")
        {
            NodeTypes.Draw_IfShipIsLessThanDistanceToPointInSpace(node);
        }
        ...
        else if (node.nodeType == "ifshipsshieldsarelessthan")
        {
            NodeTypes.Draw_IfShipsShieldsAreLessThan(node);
        }
