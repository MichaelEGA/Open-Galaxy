...
public static class NodeTypes
{
    ...
    public static void Draw_PreLoad_LoadSingleShipAsWreck(Node node)
    {
        ...
        node.data3 = NodeFunctions.DrawInputField(node, "fire number", "0", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data4 = NodeFunctions.DrawInputField(node, "fire scale min", "2", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data5 = NodeFunctions.DrawInputField(node, "fire scale max", "4", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data6 = NodeFunctions.DrawInputField(node, "seed", "1138", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_PreLoad_LoadTerrain(Node node)
    {
        ...
        NodeFunctions.DrawText(node, "pl_loadterrain", 8, 5f, -5, 12.5f, 65);
        ...
        node.data1 = NodeFunctions.DrawInputField(node, "seed", "1138", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_PreLoad_LoadTiles(Node node)
    {
        ...
        List<string> options01 = new List<string>();
        options01.Add("deathstar");

        node.data2 = NodeFunctions.DrawDropDownMenu(node, options01, "tiles", "deathstar", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_ActivateSystemsTargeting(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "activatesystemstargeting", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "activatesystemstargeting", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_ExitMissionAndLoadNextMission(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "exitmissionandloadnextmission", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "exitmissionandloadnextmission", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_DisplayChoice(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "displaychoice", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "displaychoice", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_DisplayHangarLaunch(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "displayhangarlaunch", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "displayhangarlaunch", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_IfChoiceEquals(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifchoiceequals", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifchoiceequals", 7, 5, drop, 12.5f, 90);
        ...
        node.data1 = NodeFunctions.DrawInputField(node, "choice", "nochoice", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_IfChoiceHasBeenMade(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifchoicehasbeenmade", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifchoicehasbeenmade", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_IfKeyboardIsActive(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifkeyboardisactive", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifkeyboardisactive", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_IfNumberOfShipsIsLessThan(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifnumberofshipsislessthan", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifnumberofshipsislessthan", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_IfNumberOfShipsOfAllegianceIsLessThan(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifnumberofshipsofallegianceislessthan", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifnumberofshipsofallegianceislessthan", 7, 5, drop, 12.5f, 90);
        ...
        node.data2 = NodeFunctions.DrawInputField(node, "Number", "0", 7, 5, drop, 12.5f, 90, 5f);
        ...
        node.data3 = NodeFunctions.DrawDropDownMenu(node, options2, "mode", "allships", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_IfNumberOfShipsWithNameIsLessThan(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifnumberofshipswithnameislessthan", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifnumberofshipswithnameislessthan", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_IfShipIsLessThanDistanceToPointInSpace(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifshipislessthandistancetopointinspace", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifshipislessthandistancetopointinspace", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_IfShipsShieldsAreLessThan(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifshipsshieldsarelessthan", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifshipsshieldsarelessthan", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_IfStringEquals(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifstringequals", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifstringequals", 7, 5, drop, 12.5f, 90);
        ...
        node.data1 = NodeFunctions.DrawDropDownMenu(node, GetSlotList(), "slot", "0", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data2 = NodeFunctions.DrawInputField(node, "string", "none", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_IfSystemIsActive(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "ifsystemisactive", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "ifsystemisactive", 7, 5, drop, 12.5f, 90);
        ...
        options.Add("engine");
        options.Add("shield");
        options.Add("dovinbasal");

        node.data2 = NodeFunctions.DrawDropDownMenu(node, options, "system", "any", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_LoadExplosion(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "loadexplosion", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "loadexplosion", 7, 5, drop, 12.5f, 90);
        ...
        explosionOptions.Add("explosion_system_ion");
        explosionOptions.Add("explosion_torpedo");
        explosionOptions.Add("explosion_wreck");
        explosionOptions.Add("blackhole");

        node.data1 = NodeFunctions.DrawDropDownMenu(node, explosionOptions, "type", "explosion_smallship", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data2 = NodeFunctions.DrawInputField(node, "size", "25", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_LoadSingleShipFromHangar(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "loadsingleshipfromhanagr", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "loadsingleshipfromhangar", 7, 5, drop, 12.5f, 90);
        ...
        node.data4 = NodeFunctions.DrawInputField(node, "launchship", "none", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data5 = NodeFunctions.DrawInputField(node, "cargo", "no cargo", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_PlayVideo(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "playvideo", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "playvideo", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_SaveString(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "savestring", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "savestring", 7, 5, drop, 12.5f, 90);
    ...
    public static void Draw_SetCamera(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "setcamera", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "setcamera", 7, 5, drop, 12.5f, 90);
        ...
        List<string> options1 = new List<string>();
        options1.Add("gamemode");
        options1.Add("filmmode");

        node.data1 = NodeFunctions.DrawDropDownMenu(node, options1, "mode", "gamemode", 7, 5, drop, 12.5f, 90, 5f);
        ...
        node.data2 = NodeFunctions.DrawDropDownMenu(node, options2, "shottype", "freelook", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data3 = NodeFunctions.DrawInputField(node, "target ship", "none", 7, 5, drop, 12.5f, 90, 5f);
        ...
        node.data4 = NodeFunctions.DrawDropDownMenu(node, options5, "move", "false", 7, 5, drop, 12.5f, 90, 5f);
        ...
        node.data5 = NodeFunctions.DrawDropDownMenu(node, options6, "move axis", "xaxis", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data6 = NodeFunctions.DrawInputField(node, "move speed", "50", 7, 5, drop, 12.5f, 90, 5f);
        ...
        node.data7 = NodeFunctions.DrawDropDownMenu(node, options7, "rotate", "false", 7, 5, drop, 12.5f, 90, 5f);
        ...
        node.data8 = NodeFunctions.DrawDropDownMenu(node, options8, "rotate axis", "xaxis", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data9 = NodeFunctions.DrawInputField(node, "rotate speed", "50", 7, 5, drop, 12.5f, 90, 5f);
        ...
        node.data11 = NodeFunctions.DrawInputField(node, "shake rate", "1", 7, 5, drop, 12.5f, 90, 5f);

        drop -= 15;

        node.data12 = NodeFunctions.DrawInputField(node, "shake strength", "0.7", 7, 5, drop, 12.5f, 90, 5f);
    ...
    public static void Draw_SetHudMode(Node node)
    {
        NodeFunctions.DrawNodeBase(node);

        NodeFunctions.DrawNodeLink(node, 7.5f, -12f, 10, 10, "female");

        NodeFunctions.DrawText(node, "sethudmode", 8, 17.5f, -5, 12.5f, 65);
        ...
        node.eventType = NodeFunctions.DrawText(node, "sethudmode", 7, 5, drop, 12.5f, 90);
    ...
    public static List<string> GetSlotList()
    {
        ...
        while (slotIndex < 100)
        {
            slotList.Add(slotIndex.ToString());
            slotIndex++;
        }
